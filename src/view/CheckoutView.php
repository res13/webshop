...
class CheckoutView extends View
{
    ...
    public function renderMustLogin(&$languageController)
    {
        ...
        $result .= "<a href=\"login\">" . $languageController->getTextForLanguage("LOGIN") . " </a>" . $languageController->getTextForLanguage("OR") . " <a href=\"register.php\">" . $languageController->getTextForLanguage("REGISTER") . "</a></br></br></div></body>";
        return $result;
    }
