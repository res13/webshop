        ...
        <div class="col-25">
            <div class="container">
                <form method="post">
                    ...
                    <label><?php echo getTextForLanguage("COUNTRY") ?><br/><select class="selectLog" name="country">
                            <?php
                    ...
                    <label><?php echo getTextForLanguage("LANGUAGE") ?><br/><select class="selectLog" name="lang">
                            <?php
