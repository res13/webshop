...
class BasketView extends View
{
    ...
    public function render($languageController)
    {
        ...
        if ($show) {
            $result .= "<h2><a href='cleanBasket.php'>" . $languageController->getTextForLanguage("CLEAN_BASKET") . "</a></h2>";
        }
        ...
        if ($show) {
            ...
            $result .= $this->orderTableController->getContent($basket, $products, true);
        } else {
