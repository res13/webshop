            ...
            <div class=\"wrapper-small\" data-name=\"" . htmlentities($product->name) . "\">
                ...
                <div class=\"product-info-small\">
                    ...
                    <div class=\"product-price-btn-small\">
                        <p><span>" . htmlentities($product->price) . "</span>CHF</p><a href=\"product.php?id=$product->id\"><button type=\"button\">" . $languageController->getTextForLanguage("PRODUCT") . "</button></a>
                    </div>
                </div>
            </div>
            </div>";
